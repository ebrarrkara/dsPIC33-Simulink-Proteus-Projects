 ...
 * -------------------------------------------------------------------
 * File: project_01_button_led_control.c
 *
...
/* Model step function */
void project_01_button_led_control_step(void)
{
...
void project_01_button_led_control_initialize(void)
{
...
void project_01_button_led_control_terminate(void)
{
...
void MCHP_Scheduler(void)
{
  for (;;) {                           /* Infinite loop, no return */
    ...
    project_01_button_led_control_step();
