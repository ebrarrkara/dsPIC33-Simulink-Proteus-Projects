 ...
 * -------------------------------------------------------------------
 * File: project_01_button_led_control_main.c
 *
...
#pragma config POSCMD = HS, OSCIOFNC = ON, IOL1WAY = OFF, FCKSM = CSECMD
#pragma config FWDTEN = OFF
#pragma config FPWRT = PWR1
#pragma config JTAGEN = OFF

#define MCHP_isMainFile
#include "project_01_button_led_control.h"
#include "project_01_button_led_control_private.h"
...
int main()
{
  ...
  /* Initialize model */
  project_01_button_led_control_initialize();
