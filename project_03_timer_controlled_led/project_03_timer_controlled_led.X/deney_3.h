...
extern const ConstB_deney_3_T deney_3_ConstB;/* constant block i/o */
 ...
 * '<S2>'   : 'deney_3/Edge Detector'
 * '<S3>'   : 'deney_3/S-R Flip-Flop'
 * '<S4>'   : 'deney_3/Edge Detector/Model'
 * '<S5>'   : 'deney_3/Edge Detector/Model/NEGATIVE Edge'
 * '<S6>'   : 'deney_3/Edge Detector/Model/POSITIVE Edge'
 */
#endif                                 /* deney_3_h_ */
