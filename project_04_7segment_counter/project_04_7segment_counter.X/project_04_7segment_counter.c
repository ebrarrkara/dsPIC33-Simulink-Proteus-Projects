 ...
 * -------------------------------------------------------------------
 * File: project_04_7segment_counter.c
 *
...
#include "project_04_7segment_counter.h"
#include <math.h>
#include "project_04_7segment_counter_private.h"
#include "rtwtypes.h"
#include <float.h>

/* Block signals and states (default storage) */
DW_project_04_7segment_counter_T project_04_7segment_counter_DW;
...
/* Model step function */
void project_04_7segment_counter_step(void)
{
  real_T rtb_Memory;
  real_T tmp;
  ...
  /* Memory: '<Root>/Memory' */
  rtb_Memory = project_04_7segment_counter_DW.Memory_PreviousInput;
   ...
   *  Rounding: '<Root>/Fix'
   */
  tmp = fmod(floor(project_04_7segment_counter_ConstP.Constant5_Value[(int16_T)floor(0.1 *
    project_04_7segment_counter_DW.Memory_PreviousInput)]), 65536.0);
   ...
   */
  tmp = fmod(floor(project_04_7segment_counter_ConstP.Constant5_Value[(int16_T)rt_modd
                   (project_04_7segment_counter_DW.Memory_PreviousInput, 10.0)]), 65536.0);
   ...
   *  S-Function (MCHP_Digital_Input): '<Root>/Digital Input'
   */
  rtb_LogicalOperator = (PORTAbits.RA10 || (rtb_Memory >= 100.0));

  /* CombinatorialLogic: '<S3>/Logic' incorporates:
   *  Memory: '<S3>/Memory'
   */
  rtb_DigitalInput_o1 = project_04_7segment_counter_ConstP.Logic_table[((((uint16_T)rtb_DigitalInput_o1 << 1)
    + rtb_LogicalOperator) << 1) + project_04_7segment_counter_DW.bitsForTID0.Memory_PreviousInput_f];
  ...
  if (rtb_LogicalOperator) {
     ...
     */
    project_04_7segment_counter_DW.Memory_PreviousInput = 0.0;
     ...
     *  Sum: '<Root>/Sum'
     */
    project_04_7segment_counter_DW.Memory_PreviousInput = rtb_Memory + 0.1;
  } else {
    /* Update for Memory: '<Root>/Memory' incorporates:
     *  Switch: '<Root>/Switch'
     */
    project_04_7segment_counter_DW.Memory_PreviousInput = rtb_Memory;
  }

  /* End of Switch: '<Root>/Switch1' */

  /* Update for Memory: '<S3>/Memory' */
  project_04_7segment_counter_DW.bitsForTID0.Memory_PreviousInput_f = rtb_DigitalInput_o1;
}

/* Model initialize function */
void project_04_7segment_counter_initialize(void)
{
...
void project_04_7segment_counter_terminate(void)
{
...
void MCHP_Scheduler(void)
{
  for (;;) {                           /* Infinite loop, no return */
    ...
    project_04_7segment_counter_step();
